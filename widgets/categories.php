...
class GantryWidgetCategories extends GantryWidget {
    ...
    function render($args, $instance){
		...
		$cat_args = array('orderby' => $instance['orderby'], 'show_count' => $instance['show_count'], 'hierarchical' => $instance['hierarchical'], 'class' => $menu_class, 'hide_empty' => $instance['hide_empty'], 'exclude' => $instance['exclude'], 'depth' => $instance['depth']);
