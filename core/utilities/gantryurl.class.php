<?php
/**
 * @version $Id: gantryurl.class.php 58595 2012-12-11 19:59:45Z btowles $
 ...
 */
    ...
    class GantryUrl {
        ...
        function explode($sUrl) {
            $parts = array('scheme','user','pass','host','path','fragment');
            $aUrl = parse_url($sUrl);
            ...
            foreach ($parts  as $part){
                if (!array_key_exists($part, $aUrl)) $aUrl[$part] = null;
            }
            return $aUrl;
        }
        /**
